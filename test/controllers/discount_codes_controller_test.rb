...
class DiscountCodesControllerTest < ActionController::TestCase
  ...
  test "should create discount_code" do
    assert_difference('DiscountCode.count') do
      post :create, discount_code: { discount_percentage: @discount_code.discount_percentage, name: @discount_code.name }
    end
  ...
  test "should update discount_code" do
    patch :update, id: @discount_code, discount_code: { discount_percentage: @discount_code.discount_percentage, name: @discount_code.name }
    assert_redirected_to discount_code_path(assigns(:discount_code))
  end
